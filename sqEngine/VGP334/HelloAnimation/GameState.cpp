...
void GameState::Initialize()
{
	...
	mAnimationBuilder.AddPositionKey({ 0.0f, 5.0f, 0.0f }, 0.0f);
	mAnimationBuilder.AddPositionKey({ 10.0f, 5.0f, 0.0f }, 2.0f);
	mAnimationBuilder.AddPositionKey({ 0.0f, 5.0f, 0.0f }, 4.0f);
	mAnimationBuilder.AddPositionKey({ -10.0f, 5.0f, 0.0f }, 6.0f);
	mAnimationBuilder.AddPositionKey({ 0.0f, 5.0f, 0.0f }, 8.0f);

	mAnimationBuilder.AddRotationKey(Quaternion::RotationEuler({ 0.0f, Constants::Pi * 0.5f, 0.0f }), 2.0f - turnTime);
	mAnimationBuilder.AddRotationKey(Quaternion::RotationEuler({ 0.0f, -Constants::Pi * 0.5f, 0.0f }), 2.0f + turnTime);
	mAnimationBuilder.AddRotationKey(Quaternion::RotationEuler({ 0.0f, -Constants::Pi * 0.5f, 0.0f }), 6.0f - turnTime);
	mAnimationBuilder.AddRotationKey(Quaternion::RotationEuler({ 0.0f, Constants::Pi * 0.5f, 0.0f }), 6.0f + turnTime);
	mAnimationBuilder.AddScaleKey(Vector3::One, 0.0f);
	mAnimation = mAnimationBuilder.Get();
...
void GameState::Update(float deltaTime)
{
	...
	const float time = sqEngine::Core::TimeUtil::GetTime();
	...
	mBallRenderObject.transform.rotationQ = mAnimation.GetRotation(mAnimationTime);
	//mBallRenderObject.transform.position.y = 1;
